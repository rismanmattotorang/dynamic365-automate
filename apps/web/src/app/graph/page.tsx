...
const HOP_SUGGESTIONS = [
  'impact of changing LedgerGeneralJournalEntry',
  'callers of GTFinPostJournal',
  'what depends on table GeneralJournalAccountEntry',
  'downstream from ZIF_FIN_POSTABLE',
  'trace from period close to FIN-CORE solution',
];
const GLOBAL_SUGGESTIONS = [
  'period close GeneralJournalAccountEntry',
  'goods movement',
    ...
    <>
      ...
      <div className="p-6 space-y-6 max-w-[1500px]">
        ...
        <div className="flex gap-2 border-b border-ink-800 pb-2">
          {[
            { id: 'multi_hop' as const, label: 'L4 HippoRAG (multi-hop)', desc: 'PPR over the Dynamics 365 graph' },
        ...
        <Card title="How this works">
          <div className="text-xs text-zinc-400 leading-relaxed space-y-2">
            <p>The server holds a typed cross-domain graph: X++ objects, OData services, data entities, Power Automate flows, Dataverse solutions, Learn pages, and business concepts.</p>
...
function KindBadge({ kind }: { kind: string }) {
  const tone: any = {
    XppObject: "accent", Service: "accent", DataEntity: "good",
    Flow: "warn", Solution: "neutral", LearnPage: "good",
