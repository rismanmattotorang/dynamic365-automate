// Same-origin proxy to the D365-Automate MCP server's HTTP transport.
...
export async function GET() {
  return NextResponse.json({
    ok: true,
    target: TARGET,
    hint: 'POST a JSON-RPC 2.0 message to this endpoint to call the D365-Automate MCP server.',
  });
}
