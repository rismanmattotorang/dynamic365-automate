//! D365-Automate cross-domain knowledge graph.
//!
//! Implements the substrate that paper §VII-F (GraphRAG), §VII-G
//! (HippoRAG), and §VII-E (RAPTOR) all sit on top of:
//!
//!   - Typed entities spanning X++ / OData service / data entity / flow / solution / Learn
//!   - Typed edges (calls, implements, reads_entity, references, etc.)
