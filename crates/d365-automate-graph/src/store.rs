...
impl InMemoryGraph {
    ...
    fn seed(&mut self) {
        ...
        add(
            self,
            "xpp:GTFinJournalPoster",
            EntityKind::XppObject,
            "GTFinJournalPoster",
            "Helper class implementing GTFinPostable.",
            Some("xpp-obj://GTFin/GTFinJournalPoster"),
            &["module:GeneralLedger", "model:GTFin", "kind:class"],
        );
        add(
            self,
            "xpp:GTFinPostable",
            ...
            Some("xpp-obj://GTFin/GTFinPostable"),
            &["module:GeneralLedger", "model:GTFin", "kind:interface"],
        );
        add(
            self,
            "xpp:GTFinConstants",
            ...
            Some("xpp-obj://GTFin/GTFinConstants"),
            &["module:GeneralLedger", "model:GTFin", "kind:class"],
        );
        add(
            self,
            ...
            Some("xpp-obj://GTFin/GTFinValidation"),
            &["module:GeneralLedger", "model:GTFin", "kind:class"],
        );
        add(
            self,
            ...
            Some("xpp-obj://GTScm/GTScmGrnCheck"),
            &["module:SupplyChain", "model:GTScm", "kind:class"],
        );

        // OData services / Custom Service operations
        add(
            self,
            "svc:LedgerGeneralJournalEntry",
            EntityKind::Service,
            "LedgerGeneralJournalEntry",
            "Post a general ledger journal entry.",
            Some("d365-service://LedgerGeneralJournalEntry"),
            &["module:GeneralLedger", "group:Ledger"],
        );
        add(
            self,
            "svc:InventoryGoodsReceipt",
            EntityKind::Service,
            "InventoryGoodsReceipt",
            "Post a product (goods) receipt.",
            Some("d365-service://InventoryGoodsReceipt"),
            &["module:SupplyChain"],
        );
        add(
            self,
            "svc:ReleasedProductGetDetail",
            EntityKind::Service,
            "ReleasedProductGetDetail",
            "Read released product detail.",
            Some("d365-service://ReleasedProductGetDetail"),
            &["module:SupplyChain", "group:Product"],
        );
        add(
            self,
            "svc:SalesOrderCreate",
            EntityKind::Service,
            "SalesOrderCreate",
            "Create a sales order.",
            Some("d365-service://SalesOrderCreate"),
            &["module:Sales"],
        );
        ...
        add(
            self,
            "ent:CompaniesV2",
            EntityKind::DataEntity,
            "CompaniesV2",
            "Legal entities / companies.",
            Some("d365-entity://CompaniesV2/structure"),
            &["module:GeneralLedger"],
        );
        add(
            self,
            "ent:FiscalCalendarPeriod",
            EntityKind::DataEntity,
            "FiscalCalendarPeriod",
            "Ledger fiscal periods.",
            Some("d365-entity://FiscalCalendarPeriod/structure"),
            &["module:GeneralLedger"],
        );
        add(
            self,
            "ent:ReleasedProductsV2",
            EntityKind::DataEntity,
            "ReleasedProductsV2",
            "Released products / item master.",
            Some("d365-entity://ReleasedProductsV2/structure"),
            &["module:SupplyChain"],
        );
        add(
            self,
            "ent:SalesOrderHeadersV2",
            EntityKind::DataEntity,
            "SalesOrderHeadersV2",
            "Sales order headers.",
            Some("d365-entity://SalesOrderHeadersV2/structure"),
            &["module:Sales"],
        );
        add(
            self,
            "ent:LedgerJournalTrans",
            EntityKind::DataEntity,
            "LedgerJournalTrans",
            "General journal lines.",
            Some("d365-entity://LedgerJournalTrans/structure"),
            &["module:GeneralLedger"],
        );
        add(
            self,
            "ent:GeneralJournalAccountEntry",
            EntityKind::DataEntity,
            "GeneralJournalAccountEntry",
            "Subledger general journal account entries (the universal accounting truth).",
            Some("d365-entity://GeneralJournalAccountEntry/structure"),
            &["module:GeneralLedger"],
        );
        ...
        add(
            ...
            "Phase-out billing engine.",
            Some("solution://LEGACY-BILL"),
            &["lifecycle:phase_out"],
        );
        ...
        add(
            self,
            "learn:finance/period-close",
            EntityKind::LearnPage,
            "Financial period close in Dynamics 365 Finance",
            "Procedure for ledger period-end close.",
            Some("d365-learn://finance/period-close"),
            &["module:GeneralLedger"],
        );
        add(
            self,
            "learn:scm/product-receipt",
            EntityKind::LearnPage,
            "Product receipt posting",
            "Procedure for posting product receipts.",
            Some("d365-learn://scm/product-receipt"),
            &["module:SupplyChain"],
        );
...
mod tests {
    ...
    fn demo_corpus_has_cross_domain_edges() {
        ...
        assert!(g
            ...
            .iter()
            .any(|(n, _, _)| n == "ent:GeneralJournalAccountEntry"));
        assert!(g
            .inbound("ent:GeneralJournalAccountEntry")
            .iter()
            .any(|(n, _, _)| n == "sol:FIN-CORE"));
    }
    ...
    fn find_seeds_locates_relevant_entities() {
        ...
        assert!(seeds.iter().any(|s| s == "concept:period_close"
            || s == "ent:GeneralJournalAccountEntry"
            || s == "learn:finance/period-close"));
    }
}
