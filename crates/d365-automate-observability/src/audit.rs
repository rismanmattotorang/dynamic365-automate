...
pub struct AuditEntry {
    ...
    /// MCP tool name (e.g. "d365.workflow.create_purchase_order").
    pub tool: String,
    /// Dynamics 365 environment identity (env + legal entity) at call time.
...
mod tests {
    ...
    async fn audit_log_records_via_sink() {
        ...
        log.record(AuditEntry {
            ...
            tool: "d365.workflow.create_purchase_order".into(),
            environment: Some("gt-prod/USMF".into()),
        ...
        let e = &drained[0];
        assert_eq!(e.tool, "d365.workflow.create_purchase_order");
