...
//!   - `OTEL_SERVICE_NAME`        — service name (default: `d365-automate`).
...
//!
//! Real OTLP wiring lives in `apps/d365-automate-server` behind a feature
...
pub fn init_default() {
    INIT.get_or_init(|| {
        ...
        // application binaries (apps/d365-automate-server, ...).  This
