...
//! | Semantic    | `d365-automate-rag` corpus     | KB-resident | crawler ingestion |
//! | Procedural  | `d365-automate-skills`         | filesystem  | code review     |
//!
...
/// directly via the `d365.docs.search` MCP tool, so MemoryManager doesn't
